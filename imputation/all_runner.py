...
class ClassificationMixin(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        kwargs['glob'] = \
            ('/Users/pedroceles/Dropbox/Mestrado/Projeto/pesquisas/' +
             'classification/*/src')
...
class RegressionMixin(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        kwargs['glob'] = \
            ('/Users/pedroceles/Dropbox/Mestrado/Projeto/pesquisas/regression/' +
             '*/src')
...
class DBInfoMixin(object):
    def run_once(self, klass):
        for estimator in self.estimators:
            ...
            return [name, values.shape[0], values.shape[1], estimator.__name__, important_gap]
    ...
    def run(self):
        ...
        data = []
        for klass in self.classes:
            data.append(self.run_once(klass))
